skip = !read_terragrunt_config(find_in_parent_folders("env.hcl")).locals.enable_envoy_gateway_api

terraform {
  source = "${find_in_parent_folders("k8s-tools")}/envoy-gateway-api"
}
...
generate "provider-envoy-gateway-api" {
  path      = "provider-envoy-gateway-api.tf"
